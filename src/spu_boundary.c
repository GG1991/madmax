...
int MicroSetDisplacementOnBoundary( int dir, double strain_dir, double LX, double LY, double LZ, Vec *x )
{
  ...
  ierr = VecSetValues( *x, nnods_y0, index_y0_u0, value_y0_u0, INSERT_VALUES); CHKERRQ(ierr);
  ierr = VecSetValues( *x, nnods_z0, index_z0_u0, value_z0_u0, INSERT_VALUES); CHKERRQ(ierr);
  memset(value_x0_u0, strain[0]*LX, nnods_x0 );
  memset(value_x0_u0, strain[0]*LX, nnods_x0 );
