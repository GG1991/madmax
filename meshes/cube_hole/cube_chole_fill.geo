...
Physical Volume("IRON2") = {4};
Physical Surface("X0") = {41, 63};
Physical Surface("X1") = {103, 85};
Physical Surface("Y0") = {81, 37};
Physical Surface("Y1") = {59, 107};
Physical Surface("Z0") = {16, 14, 18, 20};
Physical Surface("Z1") = {42, 64, 108, 86};
