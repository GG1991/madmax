...
if [ -d "run_5/taylor_1" ]; then
  rm -f run_5/taylor_1/*
else
  mkdir run_5/taylor_1
fi
mv macro_* run_5/taylor_1/.
...
if [ -d "run_5/taylor_2" ]; then
  rm -f run_5/taylor_2/*
else
  mkdir run_5/taylor_2
fi
mv macro_* run_5/taylor_2/.
...
if [ -d "run_5/unifst_1" ]; then
  rm -f run_5/unifst_1/*
else
  mkdir run_5/unifst_1
fi
mv macro_* run_5/unifst_1/.
