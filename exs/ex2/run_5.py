...
fin   = "run_5/taylor_1/macro_t_1.pvtu"
PVTU  = XMLPartitionedUnstructuredGridReader(FileName=fin)
...
fin   = "run_5/taylor_2/macro_t_1.pvtu"
PVTU  = XMLPartitionedUnstructuredGridReader(FileName=fin)
Times = np.array(PVTU.TimestepValues)
...
fin   = "run_5/unifst_1/macro_t_1.pvtu"
PVTU  = XMLPartitionedUnstructuredGridReader(FileName=fin)
...
aux[1,0] = disp0;aux[1,1] = 0.0      ;aux[1,2] = fx_unifst_1;aux[1,3] = 0.0        ;
...
print "k_unifst_1   = ", ku1 ,"error =",(ku1 - ku1)/ku1 *100,"%"
print "k_taylor_1   = ", kt1 ,"error =",(ku1 - kt1)/ku1 *100,"%"     
print "k_taylor_2   = ", kt2 ,"error =",(ku1 - kt2)/ku1 *100,"%"     
