...
fin   = "run_6/direct/macro_t_1.pvtu"
...
fin   = "run_6/taylor_s/macro_t_1.pvtu"
PVTU  = XMLPartitionedUnstructuredGridReader(FileName=fin)
...
fx_taylor_s = np.trapz(stress[:,3],leng)

#----------------------------------------------------------------# 

fin   = "run_6/taylor_p/macro_t_1.pvtu"
PVTU  = XMLPartitionedUnstructuredGridReader(FileName=fin)
Times = np.array(PVTU.TimestepValues)
...
fx_taylor_p = np.trapz(stress[:,3],leng)

#----------------------------------------------------------------# 

fin   = "run_6/unifst/macro_t_1.pvtu"
PVTU  = XMLPartitionedUnstructuredGridReader(FileName=fin)
...
fx_unifst = np.trapz(stress[:,3],leng)
